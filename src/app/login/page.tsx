    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-900 mt-4">Entrar na conta</h1>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          <div className="grid grid-cols-2 gap-2 mb-5">
            <button
              ...
              className="flex items-center justify-center gap-2 border border-gray-200 rounded-lg py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
